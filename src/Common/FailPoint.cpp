...
// under USE_LIBFIU=0 fails; native non-lite builds take the USE_LIBFIU branch
// above and never reach them. Kept under #if 0 so the upstream-style source
// survives rebases; the dead methods never link anywhere.
